...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(e.response?.data?.message || e.message || "An error occurred during login")
    } finally {
      setIsLoading(false)
    }
  }
      ...
      <div className="relative hidden flex-1 lg:block">
        ...
        <div className="absolute inset-0 flex items-center justify-center p-12">
          <div className="max-w-lg text-center">
            <blockquote className="text-2xl font-medium text-primary-foreground">
              {`"BidBoard completely changed how I find clients. Instead of chasing leads, qualified buyers come directly to me."`}
            </blockquote>
            <div className="mt-8">
